...
# data = dict(
#     INPUT_PATH = Path('/net/store/cv/users/ybrima/scratch/data/archive/16000_pcm_speeches'), #/net/store/cbc/projects/Pan troglodytes/audio_PH_dataset/PH/good_data/
